...
class videoSupport {
  ...
  async startRecording() {
    ...
    this.recorder.onstop = e => {
      ...
      this.audio.src = URL.createObjectURL(this.completeBlob);
  ...
  sendSupportVideoFx() {
    this.sendSupportVideo.addEventListener("click", () => {
      this.uploadVideo(this.completeBlob);
      this.uiDisplay("showMyProgressBar");
